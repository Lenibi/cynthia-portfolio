...
- Usage: Reference from command with `@C:/Stuff/!Startup/cynthia-portfolio/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to C:/Stuff/!Startup/cynthia-portfolio/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/Stuff/!Startup/cynthia-portfolio/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
