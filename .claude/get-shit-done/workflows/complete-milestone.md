...
```bash
node "C:/Stuff/!Startup/cynthia-portfolio/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `C:/Stuff/!Startup/cynthia-portfolio/.claude/get-shit-done/templates/retrospective.md`.
