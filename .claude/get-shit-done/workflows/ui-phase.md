...
```markdown
Read C:/Stuff/!Startup/cynthia-portfolio/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/Stuff/!Startup/cynthia-portfolio/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/Stuff/!Startup/cynthia-portfolio/.claude/agents/gsd-ui-checker.md for instructions.
