...
```
Task(
  prompt="Read C:/Stuff/!Startup/cynthia-portfolio/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Stuff/!Startup/cynthia-portfolio/.claude/get-shit-done/templates/SECURITY.md`
