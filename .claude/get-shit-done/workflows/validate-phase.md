...
```
Task(
  prompt="Read C:/Stuff/!Startup/cynthia-portfolio/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Stuff/!Startup/cynthia-portfolio/.claude/get-shit-done/templates/VALIDATION.md`
