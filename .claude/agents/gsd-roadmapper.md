...
Reference full template: `C:/Stuff/!Startup/cynthia-portfolio/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/Stuff/!Startup/cynthia-portfolio/.claude/get-shit-done/templates/state.md`.
