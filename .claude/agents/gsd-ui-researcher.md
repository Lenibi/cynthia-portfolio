...
Use template from `C:/Stuff/!Startup/cynthia-portfolio/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/Stuff/!Startup/cynthia-portfolio/.claude/get-shit-done/templates/UI-SPEC.md`
